    ...
    public partial class QLDichVu : Form
    {
        ...
        private void butDel_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                textID1.Text = textID2.Text = textNum.Text = "";
                MessageBox.Show("Deleting completed", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void butSearch_Click(object sender, EventArgs e)
        {
            if (butSearch.Text.Trim() == "Hủy")
            {
                ...
                {
                    MessageBox.Show("Text box is empty!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    textSearch.Focus();
                    return;
                }
                butSearch.Text = "Hủy";
        ...
        private bool check(int k)
        {
            ...
            {
                MessageBox.Show("Room ID's values must not be null", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                textID1.Focus();
                return false;
            }
            if (textID2.Text.Trim() == "")
            {
                MessageBox.Show("Service ID's values must not be null", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                textID2.Focus();
                return false;
            }
            if (k == 1)
            {
                for (int i = 0; i < table1.Rows.Count; i++)
                {
                    ...
                    {
                        MessageBox.Show("This room "+ table1.Rows[i][0].ToString().Trim()+"already has this Service "+table1.Rows[i][1].ToString().Trim()+" counted, please pick new pair", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                        textID1.Focus();
                        return false;
                    }
                }
            ...
            {
                MessageBox.Show("Number's values must not be null", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                textNum.Focus();
                return false;
            }
            int b;
            ...
            {
                MessageBox.Show("This Number value is not valid", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                textNum.Focus();
                return false;
            }
            return true;
        ...
        private void butFree_Click(object sender, EventArgs e)
        {
            if (butFree.Text == "Thêm")
            {
                ...
                MessageBox.Show("Inserting completed", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                ...
                MessageBox.Show("Updating completed", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            if (butSearch.Text.Trim() == "Hủy") reset();
            else reset2();
        }
    }
}
